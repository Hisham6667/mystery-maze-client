        ...
        <div className="w-full">
                <form className="w-2/3 md:w-1/3 mx-auto py-10 px-5 shadow-md border-t-red-500 border-t rounded-xl">
                    ...
                    <div className="form-control mb-5">
                        ...
                        <input type="text" name='name' placeholder="Type Your Name" className="input focus:outline-none focus:bg-red-100/30" />
                    </div>
                    ...
                    <div className="form-control mb-8">
                        ...
                        <input type="url" name='url' placeholder="Type Your photo url" className="input focus:outline-none focus:bg-red-100/30" />
                    </div>
